...
class Cerydra:
    ...
    def highlight_search_terms(self, text_widget, query):
        """Executes a non-case-sensitive search and highlights all matches."""
        ...
        text_widget.tag_config('found', background='#ffe900', foreground='black')
        if first_match:
